    ...
    public void run() {
        ...
        while (true) 
        {
            try
            {
                ...
                else if(received.equals(".activeUsers")) //displays the active users
                {
                	...
                	String recipient = st.hasMoreTokens() ? st.nextToken() : null; //check if there is a next token, attempt to read, null if not there
                	...
                	{	
            			...
            			{
            				this.dos.writeUTF(recipient + " is not currently logged in.\n");
            			}
